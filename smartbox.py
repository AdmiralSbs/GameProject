...
def make_entity(self, name, move_list, level, title):
    self.name = name
...
class Handler:
    ...
    upsorn_moves = [
        ['Ask Question on Piazza', 'a student answered!'],
        ['Watch Live Code', 'she figured out the concept!'],
        ['Attend Lecture', 'it\'s surprisingly effective...'],
        ['Wholesome Email', 'TA remembers why they chose Upsorn'],
    ]

    enemy_moves = [
        ['Vague Answer', 'but the student won\'t understand until they\'re better at CS'],
        ['You know we\'re people too', 'but Upsorn\'s sympathy was over 9000!'],
        ['PA Rejected', 'Upsorn doesn\'t know what\'s wrong with her code'],
    ...
    enemy2 = gamebox.from_color(0, 0, 'purple', 2, 10)
    make_entity(enemy2, 'Joe', enemy_moves, 50, "Grunt")
